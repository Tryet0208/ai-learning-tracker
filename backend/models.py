...
class User(Base):
    ...
    access_code: Mapped[str] = mapped_column(String(50), default="")
    ...
    interests: Mapped[str] = mapped_column(String(200), default="通用学习")
    ...
    curriculum_started_at: Mapped[date | None] = mapped_column(Date, nullable=True, default=None)
